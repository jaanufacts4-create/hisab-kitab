        ...
        <div className="bg-white/70 rounded-2xl border border-ledger-red/15 shadow-sm p-5">
          ...
          {mode === 'owner' && showForgot && (
            <div className="space-y-4 text-center">
              <p className="text-ledger-ink font-semibold text-sm">Password Reset</p>
              <p className="text-ledger-inkSoft text-xs">
                Password reset ke liye admin se WhatsApp par contact karein. Woh aapka naya password set kar denge.
              </p>
              {waLink ? (
